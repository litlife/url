...
class Url
{
	...
	const VALID_SCHEMES = ['http', 'https', 'mailto', 'tg'];
	/** @var string */
	protected $scheme = '';
	/** @var string */
	protected $host = '';
	...
	public function withoutFragment(): Url
    {
		$url = clone $this;
     ...
     * @throws \Exception
     */
    public function appendToFilename($append): Url
    {
     ...
     * @throws \Exception
     */
    public function withFilename($s): Url
    {
     ...
     * @throws \Exception
     */
    public function withExtension($extension): Url
    {
	...
	public function getPathRelativelyToAnotherUrl($absoluteFilePath): Url
    {
	...
	public function getDirnameArray(): array
    {
        ...
        return explode('/', $this->getDirname());
	}

	public function withDirnameArray($array): Url
    {
		$url = clone $this;
	...
	public function getDirnameArrayWithoutEmpty(): array
    {
		$array = $this->getDirnameArray();
	...
	public function getPathQueryFragment(): Url
    {
		$url = clone $this;
